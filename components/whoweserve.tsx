...
import { Building2, UserRound, MoveRight, Lightbulb, Linkedin } from "lucide-react";
...
const TILES: Tile[] = [
  ...
  { id: "thought", title: "Thought \n Leaderships", Icon: Lightbulb, imagePath: "/servtl.jpg" },
  { id: "startup", title: "Startup \n Featuring", Icon: Building2, imagePath: "/servsu.jpg" },
...
export const WhoWeServe = () => {
  return (
    <section className="w-full px-6 py-12 md:px-20 mt-4 bg-blue-50/50 text-blue-900">
      ...
      <section className="mx-auto max-w-8xl px-4 mt-4 py-2 pb-120">
          ...
          {TILES.map(({ id, title, Icon, imagePath }) => (
            <div key={id} className="relative group">
              ...
              <div className="flex flex-col items-center justify-center rounded-2xl border border-blue-200 bg-white shadow-sm p-6 transition hover:shadow-md relative z-10">
                <h3 className="whitespace-pre-line text-center text-base font-semibold mb-2 text-blue-800">
                  {title}
                </h3>
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 transition-all duration-500 ease-out">
                ...
                <div className="relative w-64 h-88 rounded-xl overflow-hidden shadow-2xl border-2 border-blue-400 group-hover:border-blue-500 transition-all duration-300 mt-24">
